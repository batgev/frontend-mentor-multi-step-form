...
const PersonalInfo = () => {
  ...
  const handleButtonClick = () => {
    ...
    if (!phone || !phone.trim()) newErrors.phone = "This field is required";
      ...
      <form className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className={`border-2 rounded-md p-2 outline-purple-400 hover:border-purple-300 cursor-pointer ${errors.name ? "border-red-500" : "border-purple-200"}`}
            value={name}
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            id="email"
            className={`border-2 rounded-md p-2 outline-purple-400 hover:border-purple-300 cursor-pointer ${errors.email ? "border-red-500" : "border-purple-200"}`}
            value={email}
        ...
        <div className="flex flex-col gap-1 mb-4 md:mb-0">
          ...
          <input
            ...
            id="phone-number"
            className={`border-2 rounded-md p-2 outline-purple-400 hover:border-purple-300 cursor-pointer ${errors.phone ? "border-red-500" : "border-purple-200"}`}
            value={phone}
